...
QUnit.test('3Players more than one winner', function(assert) {
    ...
    assert.equal(winner[0], 'player2');
    assert.equal(winner[1], 'player3');
});

QUnit.test('4Players, no winner', function(assert) {
    var player1 = {id:'player1', hand:'paper'};
    var player2 = {id:'player2', hand:'spock'};   
    var player3 = {id:'player3', hand:'lizard'};   
    var player4 = {id:'player4', hand:'rock'};   
    
    var winner = gamesRulesManager.DecideWinner([player1, player2, player3, player4]); 
    assert.equal(winner, 'no winner');
});